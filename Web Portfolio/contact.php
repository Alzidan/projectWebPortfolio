<?php
require('koneksi.php');
$query = "SELECT * FROM contactme, socmed";
...
<body>
    ...
    <div class="top-bar">
        <h1>contact Me</h1>
        <p><a href="index.php">Home</a>/<?=$user_data['header1']?></p>
    </div>
    <!-- end top bar -->
    ...
    <div class="container main-container">
        ...
        <div class="col-md-6">
            ...
            <div class="contact-info">
                <p><i class="ion-android-call"></i><?=$user_data['phone']?></p>
                <p><i class="ion-ios-email"></i><?=$user_data['email']?></p>
                <p><i class="ion-ios-home"></i><?=$user_data['address']?></p>
            </div>
        </div>
